    ...
    <div className="body">
      ...
      <section className="home">
        ...
        <div class="home-wrapper">
                    <button className="create-account"onClick={() => window.location.href = "a-add-unit"}>Unit</button>
                    <button className="create-account"onClick={() => window.location.href = "a-add-barangay"}>Barangay</button>
        </div>
        </div>
      </section>
    </div>
